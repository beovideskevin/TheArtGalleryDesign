                ...
                var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
                    ...
                    options.shareButtons = [
                        ...
                        },
                        {
                            id:'twitter', 
                            label:'Tweet', 
                            url:'https://twitter.com/intent/tweet?text=KevinBCasas&url={{url}}'
                        },
                        {
                            id:'pinterest', 
                            label:'Pin it', 
                            url:'http://www.pinterest.com/pin/create/button/?url={{url}}&media={{image_url}}&description=KevinBCasas'
                        }
                    ];
